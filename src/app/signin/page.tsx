...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (formData.email === 'demo@naatacademy.com' && formData.password === 'Demo1234') {
        setIsLoading(false)
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="inline-block p-3 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-3">
              <button
                ...
                className="flex items-center justify-center px-4 py-3 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 transition-all duration-300 transform hover:scale-105"
              >
